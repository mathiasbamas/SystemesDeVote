...
int main()
{
    ...
    for(unsigned i = 0; i < resultatPremierTour.size(); ++i){
        cout << listeJeux[i] << " " << resultatPremierTour[i] << " voix" << endl;
    }
    for(unsigned i = 0; i < resultatPremierTour.size(); ++i)
    {
    ...
    cout << endl << "Second tour entre " << endl << "0 - " << listeJeuxSecondTour[0] << endl << "1 - " << listeJeuxSecondTour[1] << endl << endl;
    cout << listeJeuxSecondTour[0] << " " << resultatSecondTour[0] << " voix" << endl;
    cout << listeJeuxSecondTour[1] << " " << resultatSecondTour[1] << " voix" << endl << endl;
    cout << "Vainqueur : ";
